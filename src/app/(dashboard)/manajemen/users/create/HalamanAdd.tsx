...
// [BARU] Skema validasi Zod di sisi klien
...
// Komponen Halaman Tambah Pengguna
export default function CreateUserPage() {
    ...
    const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            // Hapus error untuk field gambar saat file dipilih
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // [PERBAIKAN] Validasi client-side dengan Zod
        ...
        try {
            ...
            // [PERBAIKAN] Penanganan error Zod dari backend
